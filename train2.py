...
class Player:
    def __init__(self, name, exp_rate=0.3):
        ...
        self.model.compile(optimizer=Adam(learning_rate=self.lr), loss='mean_squared_error', metrics=['accuracy'])
    ...
    #TODO: WTF IS THAT Q FUNCTION
    # at the end of game, backpropagate and update states value
    def feedReward(self, reward):
        for st in reversed(self.states):
            state = np.array(eval(st)).reshape(1, BOARD_ROWS, BOARD_COLS)
